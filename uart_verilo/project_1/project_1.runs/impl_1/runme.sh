...
HD_PWD='C:/Users/aa/Desktop/uart_verilo/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_demo.tcl -notrace
