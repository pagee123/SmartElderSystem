...
HD_PWD='C:/Users/aa/Desktop/uart_verilo/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_demo.tcl
